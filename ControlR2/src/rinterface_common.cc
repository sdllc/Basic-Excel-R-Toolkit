...
SEXP VariableToSEXP(const BERTBuffers::Variable &var) {
  ...
  case BERTBuffers::Variable::ValueCase::kRef:
  {
    ...
    if (object) {
      ...
      R_do_slot_assign(object, Rf_mkString("SheetID"), Rf_list2(ScalarInteger((int32_t)(sheet_id >> 32)), ScalarInteger((int32_t)(sheet_id & 0xffffffff))));
    }
