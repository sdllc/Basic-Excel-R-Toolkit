...
class DECLSPEC_UUID("443a0014-c3f3-4ced-a258-f170aff12659") BERT2RibbonLib;

using namespace ATL;

class CBERT2RibbonModule : public CAtlDllModuleT< CBERT2RibbonModule >
{
public:
    CBERT2RibbonModule()
	{
	...
	DECLARE_LIBID(__uuidof(BERT2RibbonLib))
